...
export default function Footer() {
  return (
    <div className='border-t mt-5 pt-5 bg-gray-100'>
      <div className='container mb-5 grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 px-10 pb-10 mb-5s'>
        <div className='flex flex-col space-y-4'>
          <h2 className="font-semibold">Hỗ trợ</h2>
          <ul className="flex flex-col space-y-2 text-sm dark:text-gray-400">
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <ul className="flex flex-col space-y-2 text-sm dark:text-gray-400">
            <li className="nav-item">
              <a rel="noopener noreferrer" aria-current="page" className="nav-link hover:underline active" href="/">
                <span>Cho thuê nhà trên Airbnb</span>
              </a>
            </li>
            <li className="nav-item">
              <a rel="noopener noreferrer" aria-current="page" className="nav-link hover:underline active" href="/">
      ...
      <div className='bg-gray-50 border-t fixed bottom-0 w-screen z-10  py-3 hidden md:block'>
        <div className='container mx-auto px-10 flex justify-between items-center text-gray-500 '>
          ...
          <div className='text-gray-700'>
            ...
            <span className="hover:underline cursor-pointer px-2 font-medium"><AttachMoneyIcon />VNĐ</span>
            <span className='px-1 cursor-pointer'><FacebookIcon /></span>
            <span className='px-1 cursor-pointer'><InstagramIcon /></span>
            <span className='px-1 cursor-pointer'><TwitterIcon /></span>
