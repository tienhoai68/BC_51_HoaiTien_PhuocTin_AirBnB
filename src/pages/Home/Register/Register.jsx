...
import "./Regisrter.scss"
import { NavLink } from 'react-router-dom'

export default function Register() {
  return (
    <div className='w-screen h-screen relative register-form'>
